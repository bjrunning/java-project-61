...
public class Even {
    private static final String EVEN_RULE = "Ответьте «да», если число четное, в противном случае ответьте «нет».";
    ...
    private static String[] generateGameData() {
        ...
        String rightAnswer = isEvenNumber(randomNumber) ? "да" : "нет";
